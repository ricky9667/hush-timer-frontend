  ...
  return (
    <>
      <div className="text-foreground mx-auto max-w-4xl px-4 py-8 leading-relaxed">
        ...
        <p className="mb-4">
          Usage Data is collected automatically and may include Your Device&apos;s IP address,
          browser type, pages visited, time spent, and unique device identifiers.
        </p>
        ...
        <p className="mb-4">
          ...
          purposes set out in this Privacy Policy. You have the right to delete or request that We
          assist in deleting the Personal Data that We have collected about You.
        </p>
