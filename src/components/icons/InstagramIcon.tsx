...
export function InstagramIcon(props: SVGProps<SVGSVGElement>) {
  ...
  const gradients = {
    pink: `instagram-pink-${id}`,
    orange: `instagram-orange-${id}`,
    yellow: `instagram-yellow-${id}`,
    purple: `instagram-purple-${id}`,
  };

  return (
    <svg viewBox="0 0 264.583 264.583" aria-hidden="true" focusable="false" {...props}>
      <defs>
        <radialGradient
          id={gradients.pink}
          cx="199.788"
      ...
      {[gradients.pink, gradients.orange, gradients.yellow, gradients.purple].map((gradient) => (
        <path
          key={gradient}
          fill={`url(#${gradient})`}
